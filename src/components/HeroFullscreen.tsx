...
const HeroFullscreen = () => {
  ...
  const skillBadges = [
    { name: "React.js", position: "top-16 left-8", delay: "0ms" },
    { name: "Flutter", position: "top-32 right-12", delay: "200ms" },
    { name: "Python", position: "top-48 left-16", delay: "400ms" },
    { name: "AWS", position: "bottom-32 right-8", delay: "600ms" },
    { name: "Node.js", position: "bottom-48 left-12", delay: "800ms" },
    { name: "UI/UX", position: "top-24 right-24", delay: "1000ms" },
    { name: "Firebase", position: "bottom-16 left-24", delay: "1200ms" },
    { name: "Docker", position: "bottom-24 right-16", delay: "1400ms" }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <p className="text-xl text-muted-foreground">Mohan S</p>
              </div>
            </div>
          ...
          <div className="relative flex justify-center items-center min-h-[600px]">
            ...
            {/* Decorative Elements */}
            <div className="absolute top-0 right-0 w-32 h-32 border-4 border-primary/30 rounded-full animate-spin" style={{ animationDuration: '20s' }}></div>
            <div className="absolute bottom-0 left-0 w-24 h-24 border-4 border-teal-500/30 rounded-full animate-spin" style={{ animationDuration: '15s', animationDirection: 'reverse' }}></div>
          </div>
        </div>
