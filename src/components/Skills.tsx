      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="mb-16">
          <div className="text-center mb-8">
            <h3 className="text-4xl font-black text-foreground mb-4">OTHER SKILLS</h3>
            <p className="text-lg text-muted-foreground">Additional tools and methodologies I work with</p>
          </div>
          
          <Card className="bg-gradient-to-br from-gray-500/20 to-slate-500/20 border-gray-500/30 border-2 hover:scale-105 transition-all duration-300">
              ...
              <div className="flex items-center justify-center gap-8">
                ...
                <div className="text-left">
                  ...
                  <div className="flex gap-2 mt-4">
                    <Badge className="bg-orange-500/20 text-orange-400 border-orange-500/30">Cloud Expert</Badge>
                  </div>
                </div>
              </div>
            </CardContent>
